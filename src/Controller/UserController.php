...
class UserController extends AbstractController
{
    ...
    //D'office dans les sécurityController
    // #[Route('/deconnexion', name: 'user.deconnexion')]
    // public function deconnexion(Request $request): Response
    //{
    //   return $this->render('Page3Deconnexion.html.twig');
    //}
